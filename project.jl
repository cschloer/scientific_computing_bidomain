...
function bidomain(;n=100,dim=1,sigma_i=1.0, sigma_e=1.0, epsilon=0.1, gamma=0.5, beta=1.0, tstep=0.05, tend=11,dtgrowth=1.0)
	...
	inival=unknowns(bidomain_system, inival=0)
